...
export default function ConsentBanner(){
  ...
  const save=(analytics)=>{try{localStorage.setItem(KEY,JSON.stringify({essential:true,analytics,at:new Date().toISOString()}))}catch{};window.dispatchEvent(new CustomEvent('codavybes:privacy-consent',{detail:{analytics}}));setOpen(false)}
  if(!open)return null
