...
export default function PlatformPostCard({ post }) {
  return <article className="platform-post surface">
    <header><div className="platform-post__identity"><Logo markOnly/><div><div><strong>CodaVybes</strong><ShieldCheck size={15}/></div><small>Official update</small></div></div><span><Radio size={13}/> UPDATE</span></header>
